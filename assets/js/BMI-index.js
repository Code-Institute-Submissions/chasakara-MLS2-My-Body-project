...
function add() {
    ...
    if (bmi <= 18.5) {
     ...
     (`Well done! Your BMI is:`, + bmi + `show that you are a healthy weight. This means that you are less likely to develop heart disease, type 2 diabetes. Healthy tip =>keep eating well and tking regular exercise. It’s important to keep up these healthy habits.`);
    }
